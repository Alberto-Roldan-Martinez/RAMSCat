...
from Library import isolated_atoms
...
ifile.write("# ave_coord\tE_Coh (eV.atom\N{SUPERSCRIPT minus}\N{SUPERSCRIPT ONE})\tElements\tPath\n")
ifile.write("{:>3.4f}\t\t{:>10.4f}\t" .format(average_coordination, cohesion_e))
