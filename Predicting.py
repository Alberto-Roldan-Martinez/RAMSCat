...
values = [coordination.cluster_size, coordination.interface_cluster, coordination.site_cluster_coordination,
		  ...
		  area.cluster_interface_area, area.cluster_surface_area, energies.e_cluster_surface, energies.e_coh,
		  energy.e_adh, energy.e_binding, energy.e_total, name]


Write_labels("Predicted.dat", labels)
write_results("Predicted.dat", values)
write_outcar(structurefile, energies.e_total)
