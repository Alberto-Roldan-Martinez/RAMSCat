...
class Graphite():
    ...
    def genY(self):
        ...
        natoms = len(self.xyz)        #show how many atoms need to move among y axis
    ...
    def genZ(self):
        ...
        natoms = len(self.xyz) #show how many atoms need to duplicate among z axis
        
        for i in range(1, self.z):     #how many times we need to duplicate
            for j in range(natoms):  #recognise different types of atoms

                ele, x, y, z = self.xyz[j]
                x = x + self.lat/2
                y = y + 0.433012702*self.lat
                z = i * self.layer
